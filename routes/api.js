...
var creatorList = ['@Xcode','@Xcodegans','@Xcode_ajalah','@Xcodeanjay', '@Xcodeganssss','@Xcpodeganteng','@Xcodegantengg', '@Xcode_Kuy'];
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------XcodeGanteng'+'XCODE--GANS';
